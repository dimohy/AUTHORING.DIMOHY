...
> 한국어 본문 문서: [`AUTHORING.DIMOHY.r25.md`](AUTHORING.DIMOHY.r25.md)

## 최신 리비전

| 언어 | 파일 |
|---|---|
| 한국어 | [`ko/AUTHORING.DIMOHY.r25.md`](AUTHORING.DIMOHY.r25.md) |
...
1. 원하는 언어의 최신 파일을 대상 프로젝트 루트에 복사하거나, 이 저장소의 파일을 명시적으로 참조합니다.
   - 한국어: `ko/AUTHORING.DIMOHY.r25.md`
...
r25에는 TaskSync 환경의 흔한 오류를 막는 규칙이 포함되어 있습니다.
